...
public class CountryHealth : MonoBehaviour
{
    ...
    //This is checking to see if the value that the slider is at and is being displayed is less than
    // or equal to zero and if it is then it will load the you lose scene.
    void Update()
    {
        if (slider.value <= 0)
        {
